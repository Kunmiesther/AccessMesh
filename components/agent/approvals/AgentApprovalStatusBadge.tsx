import { getApprovalStatusPresentation } from "./approvalPresentation";
import type { AgentApprovalStatus } from "@/services/agent/AgentApprovalTypes";

export function AgentApprovalStatusBadge({
  status,
}: {
  status: AgentApprovalStatus;
}) {
  const presentation = getApprovalStatusPresentation(status);
